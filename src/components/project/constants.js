...
const imgUrls = [
  ...
  },
  {
    ...
    description:
      "Uses pythonic data structures to generate a sentence of Arthur Conan Doyle's, The Adventures of Sherlock Holmes. Develop an nth markov chain to collect semi-random words out of a corpus to generate an approximation of a grammatically correct sentence.",
    technologies:
